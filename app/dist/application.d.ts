...
declare const Question3Application_base: (new (...args: any[]) => {
    projectRoot: string;
    ...
    migrateSchema(options?: SchemaMigrationOptions | undefined): Promise<void>;
    readonly options: ApplicationConfig;
    readonly state: string;
...
export declare class Question3Application extends Question3Application_base {
